        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-3">
            ...
            <p className="text-neutral-600 dark:text-neutral-300 mb-4 max-w-md">
              Ready to upgrade your network? Just upload a copy of your resume and we'll take care of the rest. 😊
            </p>
        ...
        <div className="mt-8 pt-8 border-t border-neutral-200 dark:border-neutral-700">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <p className="text-neutral-500 dark:text-neutral-400 text-sm mt-2 md:mt-0">
              Created by <span className="font-medium text-primary-700 dark:text-primary-300">Narayan Topalli</span> (Cornell '28)
            </p>
          </div>
        </div>
      </div>
