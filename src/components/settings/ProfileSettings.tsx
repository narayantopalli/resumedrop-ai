  ...
  return (
    <div className="bg-white dark:bg-neutral-800 rounded-lg shadow-sm border border-neutral-200 dark:border-neutral-700 p-6">
      ...
      <form onSubmit={handleProfileSubmit} className="space-y-6">
        ...
        <div className="border-t border-neutral-200 dark:border-neutral-700 pt-6">
          <h4 className="text-md font-semibold text-primary-900 dark:text-white mb-4">Privacy Settings</h4>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                {userMetadata?.isPublic ? (
                  ...
                  <FiEyeOff className="w-5 h-5 text-red-500" />
                )}
                <div>
                  <h5 className="font-medium text-primary-900 dark:text-white">
                    Profile Visibility
                  </h5>
