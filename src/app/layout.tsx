...
export const metadata: Metadata = {
  title: "resumedrop.ai - The ultimate platform for college networking!",
  description: "Ready to land your dream job? Just upload a copy of your resume and we'll take care of the rest. 😊",
